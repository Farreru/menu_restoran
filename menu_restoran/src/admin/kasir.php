...
<body id="page-top">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="cashModalItems"></div> <!-- New Section for Items -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="qrisModalItems"></div> <!-- New Section for Items -->
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                    <button type="button" class="btn btn-primary confirm-payment-btn">Saya sudah membayar</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            //     $.ajax({
            //         url: 'cartItemsModal.php',
            //         method: 'POST',
            //         data: {
            //             action: 'get_cart_items'
            //         }, // Fetch cart items for modals
            //         success: function(response) {
            //             $('#cashModalItems').html(response);
            //             $('#qrisModalItems').html(response);
            //         }
            //     });
            // }
